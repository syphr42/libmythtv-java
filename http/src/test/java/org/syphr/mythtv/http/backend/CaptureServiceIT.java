...
public class CaptureServiceIT
{
    private static final Logger LOGGER = LoggerFactory.getLogger(CaptureServiceIT.class);

    private static PropertiesManager<Settings> settings;

    private static CaptureService capture;
    ...
    public static void setUpBeforeClass() throws IOException
    {
        ...
        try
        {
            ...
            capture = services.getCaptureService();
        }

...
public class DvrServiceIT
{
    private static final Logger LOGGER = LoggerFactory.getLogger(DvrServiceIT.class);

    private static PropertiesManager<Settings> settings;

    private static DvrService dvr;

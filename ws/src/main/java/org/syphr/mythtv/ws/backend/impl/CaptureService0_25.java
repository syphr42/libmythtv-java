...
import org.syphr.mythtv.ws.backend.impl._0_25.capture.ArrayOfCaptureCard;
import org.syphr.mythtv.ws.backend.impl._0_25.capture.Capture;
import org.syphr.mythtv.ws.backend.impl._0_25.capture.CaptureCardList;
import org.syphr.mythtv.ws.backend.impl._0_25.capture.CaptureServices;
...
public class CaptureService0_25 extends AbstractCaptureService
{
    ...
    public List<CaptureCard> getCaptureCardList(String hostName, String cardType)
    {
        ...
        List<org.syphr.mythtv.ws.backend.impl._0_25.capture.CaptureCard> list = array.getCaptureCards();
        if (list == null)
        {
            return cards;
        }

        for (org.syphr.mythtv.ws.backend.impl._0_25.capture.CaptureCard rCard : list)
        {
    ...
    private CaptureCard convert(org.syphr.mythtv.ws.backend.impl._0_25.capture.CaptureCard rCard)
    {
        if (rCard == null)
        {
            return null;

...
public class RecordMatch1264 implements RecordMatch
{
    /**
     * Serialization ID
     */
    ...
    @AttributeOverrides({ @AttributeOverride(name = "recordid", column = @Column(name = "recordid")),
                         ...
                         @AttributeOverride(name = "starttime",
                                            column = @Column(name = "starttime", length = 19)),
    ...
    {
        if (id != null && !(id instanceof RecordMatchId1264))
        {
            throw new IllegalArgumentException("Invalid ID type: " + id.getClass().getName());
        }

        this.id = (RecordMatchId1264)id;
    }
    ...
    public String toString()
    {
        ...
        builder.append("RecordMatch1264 [id=");
        builder.append(id);
        builder.append("]");

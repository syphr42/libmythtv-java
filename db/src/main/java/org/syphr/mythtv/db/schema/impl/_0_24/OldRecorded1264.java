...
public class OldRecorded1264 implements OldRecorded
{
    /**
     * Serialization ID
     */
    ...
    {
        Boolean boxedGeneric = getGeneric();
        return boxedGeneric != null && boxedGeneric;
    }

    @Override
    public void setGeneric(boolean generic)
    {
        setGeneric(Boolean.valueOf(generic));
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        OldRecorded1264 other = (OldRecorded1264)obj;
        if (id == null)
        {
            if (other.id != null)
            {
    ...
    public String toString()
    {
        ...
        builder.append("OldRecorded1264 [id=");
        builder.append(id);

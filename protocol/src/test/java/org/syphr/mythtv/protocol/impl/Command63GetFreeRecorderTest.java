...
public class Command63GetFreeRecorderTest
{
    ...
    private RecorderLocation test(List<String> response) throws IOException
    {
        ...
        Command63GetFreeRecorder command = getCommand();
        try
        {
    ...
    private Command63GetFreeRecorder getCommand() throws MalformedURLException
    {
        return new Command63GetFreeRecorder(null, parser);
    }
    ...
    private void setupMocks(List<String> response) throws IOException
    {
         ...
         */
        String combined = "GET_FREE_RECORDER";

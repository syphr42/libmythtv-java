...
public class Command63BlockShutdownTest extends AbstractProtocolTest
{
    @Test
    ...
    private Command63BlockShutdown getCommand()
    {
        return new Command63BlockShutdown(null, null);
    }

...
public class Command63DeleteRecordingTest
{
    ...
    public void testSendSuccess() throws IOException, CommandException
    {
        ...
        Command63DeleteRecording command = getCommand();
    ...
    private Command63DeleteRecording getCommand()
    {
        return new Command63DeleteRecording(null,
                                            null,
                                            EasyMock.createMock(Channel.class),
                                            new Date(),
                                            false,
                                            false);
    }

...
public class Command63MessageResetIdleTimeTest
{
    ...
    private void test(String response) throws IOException, CommandException
    {
        ...
        Command63MessageResetIdleTime command = getCommand();
        try
        {
    ...
    private Command63MessageResetIdleTime getCommand()
    {
        return new Command63MessageResetIdleTime(null, parser);
    }
    ...
    private void setupMocks(String response) throws IOException
    {
        ...
        EasyMock.expect(parser.combineArguments("MESSAGE", "RESET_IDLETIME")).andReturn(combined);

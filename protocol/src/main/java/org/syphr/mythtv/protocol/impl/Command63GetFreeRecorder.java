...
/* default */class Command63GetFreeRecorder extends AbstractProtocolCommand<RecorderLocation>
{
    public Command63GetFreeRecorder(Translator translator, Parser parser)
    {

...
/* default */class Command63QueryRemoteEncoderGetCurrentRecording extends
                                                                  AbstractCommand63QueryRemoteEncoder<Program>
{
    public Command63QueryRemoteEncoderGetCurrentRecording(Translator translator,
                                                          Parser parser,
                                                          int recorderId)
    {

...
public class EventSender63UpdateFileSize implements EventSender<BackendEventListener63>
{
    ...
    public void processMessage(BackendMessage message) throws ProtocolException
    {
        ...
        if (args.size() != 3)
        {
            throw new ProtocolException("Incorrect number of arguments", Direction.RECEIVE);
        }
        ...
        size = Long.parseLong(args.get(2));
    }

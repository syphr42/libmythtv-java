...
/* default */class Command63QueryRecorderFrontendReady extends AbstractCommand63QueryRecorder<Void>
{
    public Command63QueryRecorderFrontendReady(Translator translator, Parser parser, int recorderId)
    {
